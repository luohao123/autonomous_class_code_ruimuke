...
# todo: replace dcnv1 with torchvision.ops.dcn
from torchvision.ops.deform_conv import DeformConv2d
# from models.ops.dcn.deform_conv_with_off import (DeformConvWithOff,
#                                               ModulatedDeformConvWithOff)
from alfred.utils.log import logger
try:
    # to support onnx the import should change to
    # from models.ops.DCNv2.dcn_v2_onnx import DCN
    from models.ops.DCNv2.dcn_v2 import DCN
except ImportError:
    print('DCNv2 import failed, did u run ./make.sh build it?')
    print('Disable DCNv2.')
...
class DeconvLayer(nn.Module):
    ...
    def __init__(
        ...
        #     in_planes, out_planes, kernel_size=3, groups=1
        # )
        # this is v2
        self.dcn = DCN(
            in_planes, out_planes, kernel_size=3, stride=1, padding=1, deformable_groups=1
        )
