...
if __name__ == '__main__':
    ...
    if os.path.isdir(data_f):
        ...
        for img_f in img_files:
            ...
            visualize_det_cv2_part(ori_img, scores, classes, boxes, class_names=categories, thresh=0.16, force_color=force_color, line_thickness=1,
                                   is_show=True, wait_t=100)
    else:
